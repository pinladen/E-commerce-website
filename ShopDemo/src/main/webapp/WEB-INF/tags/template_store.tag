...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img src="${pageContext.request.contextPath}/resources/store/images/icon-light.svg" width="48" height="48" alt="HexaBit"></div>
        <p>Please wait...</p>        
    </div>
</div>
...
<div id="wrapper">
            ...
            <div class="navbar-right">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="${pageContext.request.contextPath}/user/home" class="icon-menu"><i class="icon-power"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div id="left-sidebar" class="sidebar">
        <div class="navbar-brand">
            <a href="${pageContext.request.contextPath}/store/dashboard/index"><img src="${pageContext.request.contextPath}/resources/store/images/icon-dark.svg" alt="HexaBit Logo" class="img-fluid logo"><span>HexaBit</span></a>
            <button type="button" class="btn-toggle-offcanvas btn btn-sm btn-default float-right"><i class="lnr lnr-menu fa fa-chevron-circle-left"></i></button>
        </div>
        <div class="sidebar-scroll">
            <div class="user-account">
                <div class="user_div">
                    <img width="140" height="90" src="${pageContext.request.contextPath}/resources/store/images/accountphoto.jpg" class="user-photo" alt="User Profile Picture">
                </div>
                <div class="dropdown">
                    <span>Store </span>
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li><a href="app-inbox.html"><i class="icon-envelope"></i><span>Inbox</span></a></li>
                     <li>
                        ...
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/store/order/index">Order Invoice</a></li>
                        </ul>
                    </li>  
                    <li>
                        <a href="#Tables" class="has-arrow"><i class="icon-bag"></i><span>Products Management</span></a>
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/store/product/index">View Products</a></li>
                            <li><a href="${pageContext.request.contextPath}/store/product/new">New Product</a></li>                    
                        </ul>
                    </li>       
                </ul>
            </nav>     
